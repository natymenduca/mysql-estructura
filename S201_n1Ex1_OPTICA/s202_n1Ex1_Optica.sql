...
CREATE TABLE IF NOT EXISTS `s2_1ex1_optica`.`gafas` (
  ...
  `monturas_id_montura` INT NOT NULL,
  PRIMARY KEY (`id_gafas`, `proveedores_id_proveedor`, `monturas_id_montura`),
  INDEX `fk_gafas_marcas1_idx` (`marcas_id_marca` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s2_1ex1_optica`.`clientes` (
  ...
  PRIMARY KEY (`id_cliente`, `empleados_id_empleado`),
  INDEX `fk_clientes_empleados1_idx` (`empleados_id_empleado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s2_1ex1_optica`.`graduaciones` (
  ...
  `gafas_monturas_id_montura` INT NOT NULL,
